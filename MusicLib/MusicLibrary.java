...
public class MusicLibrary {
	...
	public static void initialiseMusic() {
		...
		songs.add(new Song("My heart will go on", "Celen dion", 4.21));
		songs.add(new Song("Lion king title track", "The Lion king", 2.40));
		songs.add(new Song("Angry birds title track", "Angry birds", 3.14));
		songs.add(new Song("Hanuman chalisa", "Generic", 3));
